...
class PhoneBook(tk.Tk):
    def __init__(self):
        ...
        # Надписи
        # Первая надпись
        self.lbl_rule1 = tk.Label(self, text="Поиск производится по телефону, ФИО, в любых сочетаниях.",
                                  fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_rule1.place(x=20, y=20, anchor=tk.NW)

        self.lbl_rule2 = tk.Label(self, text="Если какой-то параметр Вам не нужен, оставьте его пустым.",
                                  fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_rule2.place(x=20, y=40, anchor=tk.NW)

        # "Фамилия"
        self.lbl_fam = tk.Label(self, text="Фамилия", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_fam.place(x=20, y=110, anchor=tk.NW)
      # Имя
        self.lbl_name = tk.Label(self, text="Имя", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_name.place(x=20, y=140, anchor=tk.NW)

        # Отчество
        self.lbl_ot4 = tk.Label(self, text="Отчество", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_ot4.place(x=20, y=170, anchor=tk.NW)

        # Телефон

        self.lbl_tel = tk.Label(self, text="Телефон", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_tel.place(x=20, y=200, anchor=tk.NW)

        # город
        self.lbl_town = tk.Label(self, text="Город", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_town.place(x=20, y=230, anchor=tk.NW)

        # Улица
        self.lbl_street = tk.Label(self, text="Улица ", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_street.place(x=20, y=260, anchor=tk.NW)

        # "Дом
        self.lbl_home = tk.Label(self, text="Дом", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_home.place(x=20, y=290, anchor=tk.NW)

        # "Квартира
        self.lbl_appartament = tk.Label(self, text="Квартира", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_appartament.place(x=20, y=320, anchor=tk.NW)

        # кнопки

        # Кнопка Загрузить файл
        self.btn_file = tk.Button(self, text="Загрузить файл", width=20, height=1, bg=self.btn_color.get(),
        ...
        self.btn_clear_inp = tk.Button(self, text="Очистить ввод", width=20, height=1, bg=self.btn_color.get(),
                                       fg=self.btn_text_color.get())
        ...
        self.btn_clear_res = tk.Button(self, text="Очистить результат", width=20, height=1, bg=self.btn_color.get(),
                                       fg=self.btn_text_color.get())
        ...
        self.btn_new = tk.Button(self, text="Создать контакт", width=20, height=1, bg=self.btn_color.get(),
        ...
        self.btn_delete = tk.Button(self, text="Удалить", width=20, height=1, bg=self.btn_color.get(),
                                    fg=self.btn_text_color.get(), state=tk.DISABLED)
        ...
        self.btn_find = tk.Button(self, text="Поиск", width=10, height=1, bg=self.btn_color.get(),
        ...
        self.btn_opt = tk.Button(self, text="Настройки", compound=tk.LEFT, width=20, height=1, bg=self.btn_color.get(),
                                 fg=self.btn_text_color.get())
        ...
        self.text_res = ttk.Treeview(master=self, columns=columns, show="headings", height=43)
    ...
    def neww(self, event):
        ...
        self.lbl_telw = tk.Label(self.newwind, text="Телефон", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_telw.place(x=20, y=20, anchor=tk.NW)

        # "Фамилия"
        self.lbl_famw = tk.Label(self.newwind, text="Фамилия", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_famw.place(x=20, y=60, anchor=tk.NW)



        # Имя
        self.lbl_namew = tk.Label(self.newwind, text="Имя", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_namew.place(x=20, y=100, anchor=tk.NW)

        # Отчество
        self.lbl_ot4w = tk.Label(self.newwind, text="Отчество", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_ot4w.place(x=20, y=140, anchor=tk.NW)



        # "город"
        self.lbl_townw = tk.Label(self.newwind, text="Город", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_townw.place(x=20, y=180, anchor=tk.NW)

        # "улица"
        self.lbl_streetw = tk.Label(self.newwind, text="Улица", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_streetw.place(x=20, y=220, anchor=tk.NW)

        # "дом"
        self.lbl_homew = tk.Label(self.newwind, text="Дом", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_homew.place(x=20, y=260, anchor=tk.NW)

        # "вартира"
        self.lbl_appartamentw = tk.Label(self.newwind, text="Квартира", fg=self.font_color.get(), bg=self.bg_color.get())
        self.lbl_appartamentw.place(x=20, y=300, anchor=tk.NW)

        self.btn_made = tk.Button(self.newwind, text="создать", width=20, height=1, bg=self.btn_color.get(),
                                  fg=self.btn_text_color.get())
    ...
    def deletew(self, event):
        ...
        self.lbl_rulesdel = tk.Label(self.deletewin, text="Найдите контакт и", fg=self.font_color.get(),
                                     bg=self.bg_color.get())
        self.lbl_rulesdel.place(relx=0, y=5, anchor=tk.NW)

        self.lbl_rulesdel2 = tk.Label(self.deletewin, text="выделите его ", fg=self.font_color.get(),
                                      bg=self.bg_color.get())
    ...
    def optionswind(self, event):
        if self.ui == 0:
            ...
            lbl_color_ent = tk.Label(tab1, text="Цвет текста в поле ввода", fg=self.font_color.get())
            lbl_color_ent.place(relx=0.05, y=130, anchor=tk.NW)

            lbl_color_enter = tk.Label(tab1, text="Цвет поля ввода", fg=self.font_color.get())
            lbl_color_enter.place(relx=0.05, y=160, anchor=tk.NW)

            btn_prim = tk.Button(tab1, text="применить", width=10, height=1, bg="grey", fg="black")
            btn_prim.bind("<Button-1>", self.cconfig)
            btn_prim.place(relx=0.75, y=370, anchor=tk.SW)

            btn_cansel = tk.Button(tab1, text="отмена", width=10, height=1, bg="grey", fg="black")
            btn_cansel.bind("<Button-1>", self.cansel)
            btn_cansel.place(relx=0.5, y=370, anchor=tk.SW)

            btn_ok = tk.Button(tab1, text="ок", width=10, height=1, bg="grey", fg="black")
